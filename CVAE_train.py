...
def _trainCVAE(numberofimages = 1024,rootpath = "generatepicture_DP",logpath = "./logs/traincvae/dp_loss",EPOCH = 8,add_noise = True,\
    ...
    ConditionalAutoEncoder.save()


if __name__ == "__main__":
    # _trainCVAE(rootpath="generatepicture_dpwithclassifier",logpath="./logs/traincvae/dpwithclassifier")
    _trainCVAE(rootpath="generatepicture_dpwithclassifier",logpath="./logs/traincvae/dpwithclassification",EPOCH=16,add_noise=True,use_classification=True)
